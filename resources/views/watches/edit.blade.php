...
@section('content')
    <div class="container">
        <form action="/watches/{{$watch->id}}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="reference" type="text" class="form-control @error('reference') is-invalid @enderror"
                               name="reference"
                               value="{{old('reference') ?? $watch->reference}}"
                    ...
                    <div class="form-group row">
                        ...
                        <input id="featured_image" type="file"
                               ...
                               name="featured_image"
                               value="{{old('featured_image') ?? $watch->image}}" autocomplete="featured_image"
                               autofocus>
                    ...
                    <div class="row py-4">
                        <button class="btn-primary btn">{{__('Update watch')}}</button>
                    </div>
                </div>
            </div>
        </form>
